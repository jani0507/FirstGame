...
public class MapGenerator : MonoBehaviour
{
   ...
   [Range(0, 1)]
    ...
    bool MapIsFullyAccesible(bool[,] obstacleMap, int currectObstacleCount)
    {
        ...
        int targetAccesibleTileCount = (int)(currentMap.mapSize.x * currentMap.mapSize.y - currectObstacleCount);
